...
var criteriaInput = function () {
  ...
  if (passwordCrit.lowercase || passwordCrit.uppercase || passwordCrit.numeric || passwordCrit.specialChar) {
    ...
    var validPrompt = function () {
      var userConfirm = confirm("Length: " + passwordCrit.length + ". Lowercase: " + passwordCrit.lowercase + ". Uppercase: " + passwordCrit.uppercase + ". Numeric: " + passwordCrit.numeric + ". Special: " + passwordCrit.specialChar + ". Confirm Selection?");
      if (userConfirm) {
